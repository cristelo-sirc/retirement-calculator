...
window.CompassIO = {
  ...
  buildPlanJSON: function (params) {
    return JSON.stringify({
      schema: this.SCHEMA, version: '18.6', savedAt: new Date().toISOString(),
      params: params || {}
    }, null, 2);
  },
    ...
    <div style={{
      ...
      <section style={{ background: cvStyles.paperWarm, borderTop: `1px solid ${cvStyles.ink}`,
        ...
        <div style={{ maxWidth: 940, margin: '0 auto' }}>
          ...
          <div style={{ ...cvKicker, textAlign: 'center', marginTop: 48 }}>Concept 07 / Cover · V18.6</div>
        </div>
      </section>
    </div>
  );
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: cvStyles.paper, color: cvStyles.ink,
      ...
      <div style={{ maxWidth: 560, width: '100%', margin: '0 auto', minHeight: '100%',
        ...
        <div style={{ ...cvKicker, marginTop: 'clamp(28px,6vw,48px)' }}>Concept 07 / Cover · Welcome · V18.6</div>
      </div>
    </div>
  );
}
