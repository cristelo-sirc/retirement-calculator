...
const FIELD_INFO = {
  ...
  numPaths: { help: 'How many market scenarios to simulate.', detail: 'Each path is one possible future. More paths give a more precise, steadier estimate of your odds but take longer to calculate. 1,500 is plenty for most plans; raise it for a touch more precision, lower it for speed. This is the single setting that drives the odds on every screen.' },
